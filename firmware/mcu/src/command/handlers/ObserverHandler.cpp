// src/command/handlers/ObserverHandler.cpp
...
void ObserverHandler::handleEnable(JsonVariantConst payload, CommandContext& ctx) {
...
void ObserverHandler::handleReset(JsonVariantConst payload, CommandContext& ctx) {
...
void ObserverHandler::handleSetParam(JsonVariantConst payload, CommandContext& ctx) {
...
void ObserverHandler::handleSetParamArray(JsonVariantConst payload, CommandContext& ctx) {
...
void ObserverHandler::handleStatus(JsonVariantConst payload, CommandContext& ctx) {
