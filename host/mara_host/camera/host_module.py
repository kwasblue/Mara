# mara_host/camera/host_module.py
"""
...
class CameraHostModule(EventHostModule):
    ...
    def _set_awb(self, camera_id: int, enabled: bool, mode: int) -> None:
        ...
        self._configs[camera_id].white_balance = enabled
        self._configs[camera_id].wb_mode = mode
    ...
    def _set_exposure(self, camera_id: int, auto: bool, value: int) -> None:
        ...
        self._configs[camera_id].exposure_ctrl = auto
    ...
    def _set_gain(self, camera_id: int, auto: bool, value: int, ceiling: int) -> None:
        ...
        self._configs[camera_id].gain_ctrl = auto
    ...
    def _apply_preset(self, camera_id: int, preset_name: str) -> None:
        ...
        client.control.set_whitebal(config.white_balance)
        client.control.set_wb_mode(config.wb_mode)
        client.control.set_exposure_ctrl(config.exposure_ctrl)
        client.control.set_aec_value(config.aec_value)
        client.control.set_gain_ctrl(config.gain_ctrl)
