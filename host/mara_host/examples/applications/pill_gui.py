# mara_host/runners/pill_gui_qt.py
...
from mara_host.motor.pill_carousel import PillCarousel, PillCarouselConfig
...
class RobotController:
    ...
    def __init__(self, log_fn: Optional[Callable[[str], None]] = None):
        self.client: Optional[MaraClient] = None
    ...
    async def connect(self):
        ...
        self.client = MaraClient(transport=transport, bus=bus)
