# mara_host/runners/bluetooth_serial_shell.py
...
from mara_host.tools.imu_calibrator import ImuCalibrator  # adjust if needed

from mara_host.transport.bluetooth_transport import (
...
async def main() -> None:
    ...
    client = MaraClient(transport=transport)
