...
class ObserverSlotWidget(SlotWidgetBase):
    """Widget for a single observer slot."""

    def _setup_info_frame(self) -> None:
        """Set up observer-specific info labels."""
    ...
    def _setup_buttons(self, btn_row: QHBoxLayout) -> None:
        """Set up observer-specific buttons."""
    ...
    def _update_display(self, config: dict) -> None:
        ...
        self._set_configured("Luenberger Observer")
...
class ObserversTab(SlotTabPanel):
    """Observers management tab."""

    NUM_SLOTS = 4
    SLOT_WIDGET_CLASS = ObserverSlotWidget
    TITLE_FORMAT = "Observer Slots ({} available)"
