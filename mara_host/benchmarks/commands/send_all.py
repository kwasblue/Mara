...
Usage:
  python -m mara_host.runners.send_all_commands --serial /dev/cu.usbserial-0001 --baud 115200
  python -m mara_host.runners.send_all_commands --serial /dev/cu.usbserial-0001 --payloads payloads.json
  python -m mara_host.runners.send_all_commands --serial /dev/cu.usbserial-0001 --only CMD_ARM,CMD_DISARM
  python -m mara_host.runners.send_all_commands --serial /dev/cu.usbserial-0001 --category control
"""
