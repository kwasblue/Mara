# mara_host/motor/pill_carousel.py
"""
Pill carousel controller built on stepper motor commands.

Migrated from mara_host/scratch/pill.py for better organization.
"""
from __future__ import annotations
from dataclasses import dataclass
from typing import Optional

# Match existing firmware command names
...
class PillCarousel:
    """
    Host-side pill carousel controller built on existing stepper commands.
    ...
    async def init_robot(self, telem_interval_ms: int = 500) -> None:
        """
        Mirrors stepper runner startup:
