# mara_host/transport/mqtt/__init__.py
"""
MQTT transport and multi-node management for ESP32 communication.

This module provides:
- MQTTTransport: Transport layer implementing HasSendBytes for MaraClient
...
Example usage (single node):
    from mara_host.transport.mqtt import MQTTTransport
