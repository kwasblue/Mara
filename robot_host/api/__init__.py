# robot_host/api/__init__.py
"""
Public API for robot control.

This is the canonical public interface for robot_host. These classes wrap
...
For advanced/internal use, HostModules can be accessed directly:
    from robot_host.hw.gpio import GpioHostModule  # internal
