#!/usr/bin/env python3
# robot_host/cli/main.py
"""MARA CLI - Modular Asynchronous Robotics Architecture.

Unified command-line interface for robot_host tools.
"""
...
from robot_host.cli.console import print_header, console
...
""",
    ...
    from robot_host.cli.commands import pins
    from robot_host.cli.commands import build
    from robot_host.cli.commands import generate
    from robot_host.cli.commands import run
    from robot_host.cli.commands import record
    from robot_host.cli.commands import config
    from robot_host.cli.commands import dashboard
    from robot_host.cli.commands import flash
    from robot_host.cli.commands import monitor
    from robot_host.cli.commands import calibrate
    from robot_host.cli.commands import test
    from robot_host.cli.commands import logs
    from robot_host.cli.commands import sim
    from robot_host.cli import completions
