# robot_host/core/host_module.py
"""
...
class CommandHostModule(ABC):
    ...
    Command modules wrap AsyncRobotClient methods to provide
    ...
    def __init__(self, bus: "EventBus", client: "AsyncRobotClient") -> None:
        ...
        Args:
            ...
            client: AsyncRobotClient for sending commands
        """
        self._bus = bus
        self._client = client
