...
class Robot:
    ...
    This is the main entry point for the robot_host library. It handles:
    ...
    def __init__(
        ...
        self._client: Optional[AsyncRobotClient] = None
    ...
    def _setup(self) -> None:
        ...
        self._bus = EventBus()
        self._client = AsyncRobotClient(self._transport, self._bus)
    ...
    @property
    def client(self) -> "AsyncRobotClient":
        """
        Access the underlying AsyncRobotClient.
