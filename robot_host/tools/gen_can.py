...
Usage:
    python -m robot_host.tools.gen_can
"""

from pathlib import Path
from typing import Dict, List, Any

from robot_host.tools.platform_schema import (
    CAN_CONFIG,
    CAN_MESSAGE_IDS,
    CAN_MESSAGES,
    CAN_NODE_STATES,
...
PY_OUT = Path("/Users/kwasiaddo/projects/Host/robot_host/transport/can_defs_generated.py")
